# Quake Live Server Standards - Duel

This Docker image contains the standard configuration for Duel as defined by [Quake Live Server Standards](https://github.com/quakelive-server-standards).
...
- `/home/steam/ql/baseq3/mappool.txt` - [Standard Duel map pool](https://github.com/quakelive-server-standards/server-framework/blob/master/mappools/standard/duel/mappool.txt)
- `/home/steam/ql/baseq3/workshop.txt`- [Standard Duel Steam workshop items](https://github.com/quakelive-server-standards/server-framework/blob/master/workshop/standard/duel/workshop.txt)
- `/home/steam/ql/baseq3/scripts/duel.factories` - [Standard Duel game type definitions](https://github.com/quakelive-server-standards/server-framework/blob/master/factories/standard/duel/duel.factories)
- `/home/steam/ql/minqlx-plugins` - [Standard Duel minqlx plugins](https://github.com/quakelive-server-standards/server-framework/tree/master/minqlx-plugins/standard/duel)
...
The name which is displayed in the Quake Live server browser. The default value is `Quake Live Server Standards - Duel`.

### `SV_TAGS`

The tags with which a server can be found in the Quake Live server browser. The default value is `duel`.
